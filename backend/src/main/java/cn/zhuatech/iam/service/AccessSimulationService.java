...
@Service public class AccessSimulationService{
 ...
 public record SimulationRequest(@NotBlank String userNo,@NotNull LocalDate asOf,@NotEmpty Set<@NotBlank String>roles,@NotEmpty List<@Valid Entitlement>entitlements,List<@Valid ConflictPair>conflicts,boolean mfaEnabled,String justification){public SimulationRequest{conflicts=conflicts==null?List.of():List.copyOf(conflicts);}}
